...
import { GreaterThan } from './simple/GreaterThan';
import { And } from './simple/And';
...
const n3Cond = new GreaterThan(new Variable('y'), new Num(2));
const n3 = new Assign('z', new IfExpression(n3Cond, new Add(new Num(1000), new Num(729)), new Add(new Num(99), new Num(22))));

const n4Cond = new And(new LessThan(new Variable('y'), new Num(20)), new GreaterThan(new Variable('y'), new Num(6)));
